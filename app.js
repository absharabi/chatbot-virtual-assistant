...
function takeCommand(message) {
    ...
    speak("If this is a real emergency, please call the local emergency number or alert someone nearby immediately.");
    window.open("https://www.google.com/search?q=emergency+services+near+me", "_blank");
